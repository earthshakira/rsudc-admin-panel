...
$sql = "INSERT INTO  frontcarouselgallery(image,title,caption) VALUES ('".$image."','".$_POST["title"]."',' ".$_POST["caption"]."')";
  ...
  $sql = "INSERT INTO  frontcarouselgallery(image,title) VALUES ('".$image."','".$_POST["title"]."')";
}else if(isset($_POST["caption"])){
  $sql = "INSERT INTO  frontcarouselgallery(image,caption) VALUES ('".$image."','".$_POST["caption"]."')";
}else {
  $sql = "INSERT INTO  frontcarouselgallery(image)  VALUES ('".$image."')";
}
