...
if(isset($_FILES["file"]))
{
    ...
    $sql = "UPDATE facultyinfo SET image=\"$image\" where id=$postid";
    ...
    if(isset($_POST["name"])){
      $sql = "UPDATE facultyinfo SET name=\"".$_POST["name"]."\" where id=$postid";
      if ($conn->query($sql) === TRUE) {
    ...
    if(isset($_POST["designation"])){
      $sql = "UPDATE facultyinfo SET designation=\"".$_POST["designation"]."\" where id=$postid";
      if ($conn->query($sql) === TRUE) {
          $response['message']="sqldone";
      } else {
          $response['message']=$sql."|".$conn->error;
    ...
    if(isset($_POST["description"])){
      $sql = "UPDATE facultyinfo SET description=\"".$_POST["description"]."\" where id=$postid";
      if ($conn->query($sql) === TRUE) {
          $response['message']="sqldone";
      } else {
          $response['message']=$sql."|".$conn->error;
