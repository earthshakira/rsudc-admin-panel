...
if(isset($_FILES["file"]))
{
    ...
    $sql = "UPDATE rsudcteam SET image=\"$image\" where id=$postid";
    ...
    if(isset($_POST["name"])){
      $sql = "UPDATE rsudcteam SET name=\"".$_POST["name"]."\" where id=$postid";
      if ($conn->query($sql) === TRUE) {
    ...
    if(isset($_POST["designation"])){
      $sql = "UPDATE rsudcteam SET designation=\"".$_POST["designation"]."\" where id=$postid";
      if ($conn->query($sql) === TRUE) {
          $response['message']="sqldone";
      } else {
          $response['message']=$sql."|".$conn->error;
    ...
    if(isset($_POST["description"])){
      $sql = "UPDATE rsudcteam SET description=\"".$_POST["description"]."\" where id=$postid";
      if ($conn->query($sql) === TRUE) {
          $response['message']="sqldone";
      } else {
          $response['message']=$sql."|".$conn->error;
