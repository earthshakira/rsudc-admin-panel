...
if(isset($_FILES["file"]))
{
    ...
    $sql = "UPDATE frontcarouselgallery SET image=\"$image\" where id=$postid";
    ...
    if(isset($_POST["title"])){
      $sql = "UPDATE frontcarouselgallery SET title=\"".$_POST["title"]."\" where id=$postid";
      if ($conn->query($sql) === TRUE) {
    ...
    if(isset($_POST["caption"])){
      $sql = "UPDATE frontcarouselgallery SET caption=\"".$_POST["caption"]."\" where id=$postid";
      if ($conn->query($sql) === TRUE) {
          $response['message']="sqldone";
      } else {
          $response['message']=$sql."|".$conn->error;
